package com.github.thiagomatar.avro.v2;
...
public class KafkaAvroJavaConsumerV2Demo {
    ...
    public static void main(String[] args) {
        ...
        KafkaConsumer<String, CustomerV2> kafkaConsumer = new KafkaConsumer<>(properties);
        ...
        while (true) {
            ...
            ConsumerRecords<String, CustomerV2> records = kafkaConsumer.poll(1000);
